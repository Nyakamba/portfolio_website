export const projects = [
...

  {
    title: "GPT-3",
    description:
      "A blog website about gpt-3, a language model developed by OpenAI, one of the world's leading artificial intelligence research organizations.",
    image: "/images/3.png",
    tags: ["React", "Node", "CSS"],
  ...
  },
  {
    title: "My Portfolio",
    description:
      "This is my personal portfolio I created showcasing my skills as a Front-end developer",
    image: "/images/4.png",
    tags: ["React", "Next", "CSS"],
  ...
  {
    title: "Gericht",
    description: "Online booking restaurant",
    image: "/images/22.png",
...
export const TimeLineData = [
  { year: 2020, text: "Learned C, C++" },
  { year: 2021, text: "Learned and did projects with Python " },
  { year: 2022, text: "Started my journey of Front-end development " },
  { year: 2023, text: "Freelance developer" },
];

export const data = [
  { number: 10, text: "Open Source Projects" },
  { number: 2000, text: "Github commits" },
  { number: 30, text: "Current Streak" },
